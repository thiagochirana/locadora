...
public class telaMarcaCarros extends javax.swing.JFrame {
    ...
    public telaMarcaCarros() {
        ...
        try {
            if (!interControle.listagem().isEmpty() || interControle.listagem() != null ) ImprimirGrid(interControle.listagem());
    ...
    private void initComponents() {
        ...
        cpInformacoesMarca = new javax.swing.JTextField();
        ...
        txtDiretorio.setForeground(new java.awt.Color(11, 149, 187));
        ...
        cpInformacoesMarca.setBackground(new java.awt.Color(250, 250, 250));
        cpInformacoesMarca.setForeground(new java.awt.Color(1, 132, 222));
        cpInformacoesMarca.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(1, 132, 222), 1, true));
        cpInformacoesMarca.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                cpInformacoesMarcaActionPerformed(evt);
            }
        });

        jLabel6.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        jLabel6.setForeground(new java.awt.Color(1, 132, 222));
        jLabel6.setText("Infor.:");
                            ...
                            .addGroup(bgBackgroundLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                ...
                                .addGroup(bgBackgroundLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                    ...
                                    .addGroup(bgBackgroundLayout.createSequentialGroup()
                                        ...
                                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                        .addComponent(cpInformacoesMarca, javax.swing.GroupLayout.PREFERRED_SIZE, 333, javax.swing.GroupLayout.PREFERRED_SIZE))))
                            .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, 41, Short.MAX_VALUE)
                            .addGroup(bgBackgroundLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                .addGroup(bgBackgroundLayout.createSequentialGroup()
                                    .addComponent(jLabel3)
                                    .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                    .addComponent(txtDiretorio, javax.swing.GroupLayout.PREFERRED_SIZE, 290, javax.swing.GroupLayout.PREFERRED_SIZE))
                                .addGroup(bgBackgroundLayout.createSequentialGroup()
                ...
                .addGroup(bgBackgroundLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(bgBackgroundLayout.createSequentialGroup()
                        .addGroup(bgBackgroundLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            .addComponent(jLabel4)
                            .addComponent(saidaLogo, javax.swing.GroupLayout.PREFERRED_SIZE, 150, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(cpInformacoesMarca, javax.swing.GroupLayout.PREFERRED_SIZE, 78, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    private void btnInserirMarcaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnInserirMarcaActionPerformed
        try {
            ...
            Marca marca = new Marca(0,cpInsMarca.getText().toUpperCase(),"./src/com/neuron/icons/logo/"+arquivoSelecionado);
    ...
    private void tabelaMarcaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tabelaMarcaMouseClicked
        try {
            ...
            txtDiretorio.setText(caminhoArquivo);
    ...
    private void cpInformacoesMarcaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cpInformacoesMarcaActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_cpInformacoesMarcaActionPerformed
    ...
    private javax.swing.JPanel bgBtnCarregarArquivo1;
    private javax.swing.JPanel bgBtnCarregarArquivo2;
    private javax.swing.JToggleButton btnAlterarMarca;
    private javax.swing.JLabel btnCarregarArquivo;
    private javax.swing.JLabel btnCarregarArquivo1;
    private javax.swing.JLabel btnCarregarArquivo2;
    private javax.swing.JToggleButton btnInserirMarca;
    private javax.swing.JLabel cpData;
    private javax.swing.JTextField cpInformacoesMarca;
